...
from configs import embed_dim, hidden_dims, dropout, dim_align_method, fuse_method, model_to_run, save_dir
...
if __name__ == "__main__":
    ...
    autoencoders.train_autoencoders(cavs=cavs, overwrite=overwrite, epochs=100, batch_size=32) #train autoencoder/ we need decoders to reconstruct the cavs for each layer
