...
class MoCoCAV(nn.Module):
    def __init__(self, input_dim, embed_dim, cavs, queue_size=4096, momentum=0.999, temperature=0.07):
        ...
        for i in range(queue_size):
            ...
            encoded_cav = F.normalize(self.key_encoder(cav), dim=0) 
    ...
    def _align_dimension_by_ae(autoencoder, cavs):
        ...
        model = MoCoCAV(input_dim=input_dim, embed_dim=1024,cavs=input_cavs, queue_size=256, momentum=0.999, temperature=0.07).cuda()
